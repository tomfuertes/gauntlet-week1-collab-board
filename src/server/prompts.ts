...
// ---------------------------------------------------------------------------
// Stage Manager - silent pre-flight that sets the stage before first exchange
...
// when players see the main response. Prompt-only here; execution wiring is task H.
// Separate system prompt (not an injection) because it's a standalone streamText call
// with its own persona: the silent Stage Manager, not an improv character.
// ---------------------------------------------------------------------------

/** Base template for the Stage Manager system prompt (no interpolation needed for the constant) */
