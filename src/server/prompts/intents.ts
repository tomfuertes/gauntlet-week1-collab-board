...
// KEY-DECISION 2026-02-21: v23 - removed explicit coords from intents. Server auto-places objects.
export const INTENT_PROMPTS: Record<string, string> = {
  ...
  "Meanwhile, elsewhere...": `Create a NEW frame (width=480 height=400) for a parallel scene. Use createPerson for 1-2 characters inside it, plus a prop sticky. This is a parallel scene happening simultaneously - same world, different angle. Do NOT call getBoardState first.`,
